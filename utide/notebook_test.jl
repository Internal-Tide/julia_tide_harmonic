...
# ╔═╡ a9daa246-73fe-4c35-8813-7ed639809ec0
begin
	using GLM
	using StatsModels
	# Generate some data
...
# ╔═╡ 9b447cf4-ddfc-4e21-90de-fa251048db20
# begin
# 	using GLM
...
# 	# 求解方程 Ax = b 的最小二乘解，返回的 result 是一个 StatsModels.TableRegressionModel 对象
# 	result = lm(A, b)
	
# 	# 输出结果
# 	println("最小二乘解：$(coeftable(result))")
# 	println("残差：$(residuals(result))")
# 	println("奇异值：$(svd(A).S)")
# end
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "3403e48815bfaa7cb9d24ae2910bee6c83b9fc1e"
